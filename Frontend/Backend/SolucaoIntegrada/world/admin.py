...
class UsuariosAdmin(admin.ModelAdmin):
    list_display = ('id', 'nome', 'email', 'is_staff', 'telefone', 'funcao', 'imagem', 'criado_em', 'criado_por')
...
class UnidadesAdmin(admin.ModelAdmin):
    list_display = ('nome', 'sistemas', 'tipo', 'localidade', 'latitude', 'longitude')
...
class ativosOperacionaisAdmin(admin.ModelAdmin):
    list_display = ('nome_de_campo','fase', 'tipo_investimento', 'etapa_do_servico', 'situacao_atual', 'proprietario', 'valor_original' , 'unidade','vida_util_reg_anos', 'vida_util_reg_meses', 'data_insercao', 'data_projeto', 'data_obra', 'data_operacao', 'criado_por', 'status', 'criado_em', 'codigo', 'latitude', 'longitude')
...
class ativosAdministrativosAdmin(admin.ModelAdmin):
    list_display = ( 'tipo_ativo', 'nome_ativo', 'código_ativo', 'criado_por', 'status', 'adquirido_por', 'proprietario', 'doacao', 'valor_original', 'valor_atual', 'data_insercao', 'unidade')
