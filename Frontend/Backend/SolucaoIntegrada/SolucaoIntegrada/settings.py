"""
Django settings for SolucaoIntegrada project.
...
SECRET_KEY = 'django-insecure-s%#^oq+@#wnov0v!--m+-pas+g-25az!v20fm6oyje&b5tts#9'
...
MIDDLEWARE = [
    ...
    'world.middleware.IPCAMiddleware',
]
...
ROOT_URLCONF = 'SolucaoIntegrada.urls'
