...
class ativosOperacionaisAdmin(admin.ModelAdmin):
    list_display = ('nome_de_campo', 'classe','fase', 'tipo_investimento', 'etapa_do_servico', 'situacao_atual', 'proprietario', 'doacao', 'valor_original' , 'unidade','vida_util_reg_anos', 'vida_util_reg_meses', 'data_insercao', 'data_projeto', 'data_obra', 'data_operacao', 'criado_por', 'status', 'criado_em', 'codigo', 'latitude', 'longitude')
